...
def mostar_pantalla_gano(pantalla, administrador):
    ...
    while flag_gano :
        ...
        texto_gana = FUENTE_MEDIA.render(f'you won!', 1, data.diccionario_set_up[COLORES]["ROSA_1"])
        ...
        pantalla.blit(texto_gana, (data.ANCHO_VENTANA/2 - (texto_gana.get_width()/2), 150))
